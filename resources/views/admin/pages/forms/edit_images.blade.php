        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="card-title">Update Slider Image</h6>

                            {!! Form::model($slides,['method' => 'PATCH', 'action'=>['SliderImagesController@update',$slides->id],'files'=>true]) !!}


                            <img style="height: 200px; width:200px;" src="/images/{{$slides->file}}" alt="">
