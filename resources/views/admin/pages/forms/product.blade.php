...
{{--                            @endforeach--}}
                          ...
                          {!! Form::text('name',null,['class'=>'form-control']) !!}
                           ...
                           <div class="form-group">
                               ...
                               {!! Form::select('category_id', [null=>'options']+App\Category::pluck('name','id')->all(),null,['class'=>'form-control show-tick']) !!}
                             ...
                             <div class="form-group">
                                   ...
                                   {!! Form::label('product_cat', 'Product Categories:') !!}
                                   {!! Form::select('category_id',[null=>'Select Option','Featured Products'=>'Featured Products','Staff Pick'=>'Staff Pick','New Products'=>'New Products'],null, ['class' => 'form-control']) !!}
                                ...
                                <table class="table">
                                    ...
                                    @foreach($products as $product)
                                      ...
                                      <tr>
                                          ...
                                          <td>{{$product->name}}</td>
                                          <td>
                                              <img style="height:200px; width:200px;" class="rounded-0" src="/images/{{$product->file}}" alt="">
